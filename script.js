...
const weddingDate = new Date('2026-07-01T14:00:00').getTime();
...
function updateCountdown() {
    ...
    if (distance < 0) {
        document.querySelector('.countdown').innerHTML =
            '<p style="font-size: 1.5rem; color: var(--gold);">День сватовства прошёл! 🎉</p>';
        return;
    }
...
// Создаём орнаменты каждые 3 секунды
